        ...
        <div className="search-result__content">
          ...
          <div className="mb-5">
            <a className="flex items-center">
              <div className="bg-success/20 dark:bg-success/10 text-success flex h-8 w-8 items-center justify-center rounded-full">
                <i className="h-4 w-4" data-lucide="inbox" />
              </div>
              <div className="ml-3">Mail Settings</div>
            </a>
            <a className="mt-2 flex items-center">
              <div className="bg-pending/10 text-pending flex h-8 w-8 items-center justify-center rounded-full">
                <i className="h-4 w-4" data-lucide="users" />
              </div>
              <div className="ml-3">Users &amp; Permissions</div>
            </a>
            <a className="mt-2 flex items-center">
              <div className="bg-primary/10 dark:bg-primary/20 text-primary/80 flex h-8 w-8 items-center justify-center rounded-full">
