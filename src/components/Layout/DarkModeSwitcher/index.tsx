...
export default function DarkModeSwitcher(props: IDarkModeSwitcherProps) {
  ...
  return (
    <div
      ...
      className="dark-mode-switcher box fixed bottom-0 left-[75px] z-50 mb-10 mr-10 flex h-12 w-40 cursor-pointer items-center justify-center rounded-full border shadow-md"
    >
